from Oristella.utils.custom_filters import (
    admin_filter,
    promote_filter,
    restrict_filter,
    can_change_filter,
...
from Oristella.utils.caching import ADMIN_CACHE, TEMP_ADMIN_CACHE_BLOCK, admin_cache_reload
from Oristella.utils.parser import mention_html
from asyncio import sleep
import os
from Oristella import BOT_ID, app
from Oristella.utils.functions import extract_user
...
async def adminlist_show(_, m: Message):
    ...
    try:
        ...
        if str(ef) == str(m.chat.id):
            ...
            await m.reply_text("error : @FamhawiteInfosysReal : `adminlist`")
    return
...
Sometimes, you promote or demote an admin manually, and Oristella doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
...
that'll force Oristella to check who the admins are again. 
"""
