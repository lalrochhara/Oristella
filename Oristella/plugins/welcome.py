...
from Oristella import app,BOT_ID,OWNER_ID,LOG_GROUP_ID
from Oristella.mongo.gban import GBan
from Oristella.mongo.usersdb import adds_served_user
from Oristella.mongo.welcomedb import Greetings
from Oristella.utils.custom_filters import admin_filter, command
...
from Oristella.utils.filter_groups import cleanner,welcomes,leftwelcome
...
my news channel @TheTheOristellabot.

**New to Me, Touch the below button and start me in PM**
                    """,
                    reply_markup=InlineKeyboardMarkup(
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/TheOristellabot?start=help"),
            ]))
