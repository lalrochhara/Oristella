...
from Oristella.mongo.usersdb import get_served_users,gets_served_users,remove_served_user
from Oristella.mongo.chatsdb import get_served_chats,remove_served_chat
...
async def gstats(_, message):
    ...
    smex = f"""
** General Stats of Oristella Bot**
