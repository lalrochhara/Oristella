...
from Oristella.mongo import taggeddb
from button import Tagalert
from Oristella.utils.filter_groups import tagallert
...
async def mentioned_alert(client, message):   
    try:
        ...
        if "@" in input_str:
            ...
            Oristella = input_str.split("|")[1]
            text = Oristella.split()[0]
...
If you are tagged/mentioned in a group where Oristella is present
Oristella will notify it to you via private message after enabling tag alerts
...
**Example:**
If you are mentioned in a group Oristella will tell you who mentioned you, 
