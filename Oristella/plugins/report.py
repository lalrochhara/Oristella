...
from Oristella.mongo.reportdb import Reporting
...
Oristella will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. Oristella assumes that admins 
