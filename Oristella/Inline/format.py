...
Oristella supports a large number of formatting 
...
- <code>[hyperlink](google.com)</code>: This will create a <a href='https://lalrochhara.github.io/'>hyperlink</a> text.
...
the user will be redirected to Oristella's PM to see the note.
"""
...
This will randomly choose between sending the first message, "hello", or the second message, "how are you".
 Use this to make Oristella feel a bit more customised! (only works in notes/filters/greetings)
